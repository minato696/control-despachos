...
import { faUser, faLock, faBroadcastTower, faSpinner, faEye, faEyeSlash } from '@fortawesome/free-solid-svg-icons'
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-white rounded-full shadow-lg mb-4">
            <FontAwesomeIcon icon={faBroadcastTower} className="text-3xl text-[#1a56db]" />
          </div>
        ...
        <p className="text-center text-sm text-[#64748b] mt-8">
          © 2024 Sistema de Control de Despachos. Todos los derechos reservados.
        </p>
      </div>
    </div>
  )
